...
func UpdateStock(w http.ResponseWriter, r *http.Request) {
	...
	msg := fmt.Sprint("Stock updated successfully. total rows/rewards affected %v", updateRows)
...
func DeleteStock(w http.ResponseWriter, r *http.Request) {
	...
	msg := fmt.Sprint("Stock deleted successfully. total rows/rewards affected %v", deleteRows)
